...
class Negociacao {
  ...
  constructor(
    _data = Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["a" /* obrigatorio */])('data'),
    _quantidade = Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["a" /* obrigatorio */])('quantidade'),
    _valor = Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["a" /* obrigatorio */])('valor')) {
...
function bindEvent(
  event = Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["a" /* obrigatorio */])('event'),
  selector = Object(__WEBPACK_IMPORTED_MODULE_0__util_index_js__["a" /* obrigatorio */])('selector'),
  prevent = true) {

  return function(target, propertyKey, descriptor) {

    Reflect.defineMetadata(
      'bindEvent', { event, selector, prevent, propertyKey },
